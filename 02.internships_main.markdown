...
* Each student is expected to present for **8 minutes**.  Q&A is done online
  through TopHat.  Please first check whether there is a duplicate question
before posting, and just give a thumbs up if you had the same question.
Presenters are expected to answer questions by the end of the day of their
presentation.
