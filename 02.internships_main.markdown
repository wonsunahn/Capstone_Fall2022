...
* Each student is expected to present for **8 minutes**.  Q&A is done online
  through TopHat (since we don't have time for an actual Q&A session).  When
posting to TopHat, please first check whether there is a duplicate question,
and just give a thumbs up if you have the same question.  Presenters are
expected to answer questions by the end of the day of their presentation.
