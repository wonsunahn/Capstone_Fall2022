...
follows:
  ...
  * **2 minutes**: Intermission
    * Audience: Peer review on TopHat, (if any) ask questions on Microsoft
      Teams
    * Current speaker: Returns to seat then starts answering questions on Microsoft
      Teams.  Q&A is due by midnight of that day, if you don't finish.
    * Next speaker: Immediately steps up to podium and starts preparing
  * Presenters: Please keep your own time with your cell phone.  Please
